...
<?php endif ?>
<p style="padding:15px;"> <a href="logout.php" class="btnn" style="background:orange; padding:8px; text-decoration:none; color:white; border-radius:5px;">Logout</a></p>
...
<form class="form-inline d-flex justify-content-center md-form form-sm active-purple-2 mt-2" action="home.php" method="POST">
  ...
  <input  class="form-control form-control-sm mr-3 w-75" type="text" name="RegistrationNumber" placeholder="Search">
    <button type="Submit" class="btn" style=" background:green;color:white;" name="search">Search</button><P style="color:darkblue;font-weight:500;">Search by Registration Number</P>
  </form>
  
  <div class="row justify-content-center">
<form action="add.php">
    <a href="audit.php" class="btn" style="background:orange; color:white;">Revenue</a>
	<a href="log.php" class="btn"  style="background:blue; color:white;">LOG</a>
	<button type="submit" class="btn"  style="background:violet; color:white;">ADD Data</button>
	<a href="view.php" class="btn" style="background:#9400D3; color:white;">VIEW ALL</a>
</form>
...
<!-- This is the old code in fms orioins 🥼  -->
