...
<div class="container">
<h2 style="margin-top: 100px; font-weight:bold; color:white">Submit Fees</h2>
<hr><hr>
...
<form action="process1.php"  method="POST" class="boc">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="panel-body">
             <input type="hidden" class="form-control" name="RegistrationNumber" value="<?php echo $row['RegistrationNumber']; ?>">
            <input type="hidden" class="form-control" name="Course" id="Course" value="<?php echo $row['Course']; ?>" >
            <input type="hidden" class="form-control" name="subject" id="subject" value="<?php echo $row['subject']; ?>" >
            <input type="hidden" class="form-control" name="Year" id="Year" value="<?php echo $row['Year']; ?>" >
            <label>Gross Fees</label><input type="text" class="form-control" name="GrossFees" id="GrossFees" value="<?php echo $row['GrossFees']; ?>"   readonly>
    ...
    function calculate() {
      ...
      if(x=="B.COM"){
        ...
        alert("Choose course and year properly");
            ...
            <label>Concession Remark</label><input type="text" class="form-control" name="ConcessionRemark" id="ConcessionRemark" value="<?php echo $row['ConcessionRemark']; ?>" readonly>
...
<div class="form-check">
 ...
 <div class="form-group">
<button type="Submit" class="btn" style="margin-top:32px; margin-left:12px; background:blueviolet; color:white;" name="fee">Submit</button>
  </div>
