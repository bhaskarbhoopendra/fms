...
$userid = $_SESSION["uid"];
 ...
 ?>
<div class="container">
<h2 style="margin-top: 100px; font-weight:bold; color:white">ADD DETAILS</h2>
<hr><hr>
...
<br>
 ...
 <div class="form-group">
<button type="Submit" class="btn" style="background:green; color:white;" name="save">Save</button>
  </div>
  </form>
</div>
</div>
