...
<body>
     <a href="student.php" class="btn btn-warning" style="float:right; margin-top:25px;margin-right:25px;background:blue; text-decoration:none; color:white; border-radius:5px;">BACK</a>
...
<form class="form-inline d-flex justify-content-center md-form form-sm active-purple-2 mt-2" action="search.php" method="POST">
  ...
  <div class="row justify-content-center" style="padding-bottom:30px;">
	...
	<a href="view1.php" class="btn" style="background:blueviolet; color:white;">VIEW ALL</a>
