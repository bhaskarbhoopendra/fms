...
<body>
  <a href="home.php" class="btn" style="float:left; margin-top:32px; margin-left:12px; background:green; color:white;">Cancel</a>
...
<form action="process.php" enctype="multipart/form-data" method="POST" class="boc">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="panel-body">
            ...
            <label>Dob</label><input type="date" class="form-control" name="DOB" value="<?php echo $row['DOB']; ?>" >
            ...
            <label>Adhar Details</label><input type="text" class="form-control" name="AdharNo" value="<?php echo $row['AdharNo']; ?>" required>
