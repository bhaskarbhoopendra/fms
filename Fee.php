...
<p style="color:darkblue;">Reciept Number:- <a id="Rnumber" onclick="script()">Generate Receipt number</a></p>
<div class="row justify-content-center">
    <p style="color:darkblue;">Student copy</p>
    </div>
	<div class="row justify-content-center" class="boc">
	    <h4><?php echo $table; ?></h4>
	    <h5 id="user1" style="display:none;"><?php echo $user; ?></h5>
	    </div>
	    <div class="row justify-content-center">
        <h2 style="color:darkblue; font-weight:bold;">Fee Receipt</h2>
        </div>
<div class="row justify-content-center">
<table class="boc text-center">
...
<h3 style="float:left; color:blue;">Clerk Sign</h3>
<h3 style="float:right; color:blue;">Student Sign</h3>
<br>
<br>

<div style="height:800px"></div>
<p style="color:darkblue;">Reciept Number:- <a id="Rnumber2" >Generate Receipt number</a></p>
<div class="row justify-content-center">
<p style="color:darkblue;">Office Copy</p>
</div>
	<div class="row justify-content-center">
...
<div class="row justify-content-center">
<button type="submit" onclick="window.print()" name="log" style="background:orange; color:white; padding:8px;" class="btn">Print</button>
</div>
</form>
</div>
</body>
